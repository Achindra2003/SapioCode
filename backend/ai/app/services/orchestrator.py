...
def _build_system_prompt(
    ...
    # ── Rich AST summary (include full issue details, not just count) ──
    ...
    ast_summary = (
        ...
        f"Functions:\n{functions_detail}\n"
        f"Data structures: {', '.join(ast_ctx.get('data_structures', [])) or 'none'}\n"
    ...
    if mode == "hint":
        return (
            ...
            "Reference the student's actual code lines by number when relevant. "
        ...
        return (
            ...
            "with a guiding question or conceptual nudge. You CAN see the student's "
            "code above — reference specific lines by number. Never write code."
        )
